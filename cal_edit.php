...
$sql1 = "update  faculty_sal SET s1='$s1',s2='$s2',gross='$gross',al1='$al1',al2='$al2',bal='$bal',ea='$ea',pt='$pt',ic='$ic',h1='$hl',ed1='$edl',o1='$o1',o2='$o2',o3='$o3',gti='$gti',pf='$pf',lic='$lic',ce='$ce',hlp='$hlp',lico='$lico',ni='$ni',oi='$oi',g='$g',d='$d',dd='$dd',c='$c',dua='$dua',ti='$ti',tax='$tax',tds='$tds' WHERE faculty_id= $id1 ";
